...
import { LADDER_DAYS, EASE_DEFAULT, EASE_MIN, EASE_MAX, CONFIDENCE, intervalDays, nextEase, acceptedLines } from './ease.js';
import { buildDecoys, DECOY_RATIO } from './decoys.js';

// Re-exported for existing callers (puzzles.js's acceptedLines import, the
// ease constants/functions test/ease.test.js imports from here): the ease
// math and the decoy heuristic now live in their own modules (server/ease.js,
// server/decoys.js), each independently tunable, but this file's public API
// is unchanged.
export { EASE_DEFAULT, EASE_MIN, EASE_MAX, CONFIDENCE, intervalDays, nextEase, acceptedLines, buildDecoys };
