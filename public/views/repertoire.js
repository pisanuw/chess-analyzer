...
export async function repertoireView(root) {
  ...
  root.innerHTML = `
    <h1>Repertoire</h1>
    <p class="muted">Analysed games grouped by the first 8 plies. "Prep ends" is the first move in the opening where you left the engine's top lines or lost 10+ win-probability points: the earliest such move across the line's games. Game links jump straight to that move.</p>
    ${section('white')}
    ${section('black')}`;
}
