  ...
  root.innerHTML = `
    ...
    <div class="grid grid-2">
      <div class="card">
        ...
        <label class="field"><span>Rating (for the coach's explanations)</span><input type="number" name="playerRating" value="${s.playerRating}"></label>

        <h3>Thresholds</h3>
        <label class="field"><span>Critical moment threshold (win-probability points lost)</span><input type="number" name="momentThreshold" value="${s.momentThreshold}" min="1" max="60"><small>10 = inaccuracy, 20 = mistake, 30 = blunder in lichess terms. Lower means more moments to explain.</small></label>
        <label class="field"><span>Drill threshold</span><input type="number" name="drillThreshold" value="${s.drillThreshold}" min="1" max="60"><small>Moments with at least this loss become drills.</small></label>
      </div>
      <div class="card">
        ...
        <div class="grid grid-2">
          <label class="field"><span>Depth</span><input type="number" name="engineDepth" value="${s.engineDepth}" min="6" max="40"><small>18 is a good default; 22+ is slow.</small></label>
          <label class="field"><span>MultiPV (lines)</span><input type="number" name="engineMultiPv" value="${s.engineMultiPv}" min="1" max="5"></label>
